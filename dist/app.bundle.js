...
var patatap = Object(__WEBPACK_IMPORTED_MODULE_1__patatap__["a" /* default */])(),
    introMessages = Object(__WEBPACK_IMPORTED_MODULE_0__introMessages__["a" /* default */])(patatap);
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = IntroMessages;
function IntroMessages(patatap) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = Patatap;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_paper__ = __webpack_require__(4);
...
function Patatap() {
  ...
  var keyData = {
    q: {
      sound: new __WEBPACK_IMPORTED_MODULE_1_howler__["Howl"]({
  ...
  return {
    init: function init() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_paper___default.a.view.onKeyDown = function (event) {
        var maxPoint = new __WEBPACK_IMPORTED_MODULE_0_paper___default.a.Point(__WEBPACK_IMPORTED_MODULE_0_paper___default.a.view.size.width, __WEBPACK_IMPORTED_MODULE_0_paper___default.a.view.size.height);
        var randomPoint = __WEBPACK_IMPORTED_MODULE_0_paper___default.a.Point.random();
        var point = maxPoint.multiply(randomPoint);
        var newCircle = new __WEBPACK_IMPORTED_MODULE_0_paper___default.a.Path.Circle(point, 200);
      ...
      __WEBPACK_IMPORTED_MODULE_0_paper___default.a.view.onFrame = function () {
